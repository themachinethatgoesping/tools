...
static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_I_Interpolator_2 =
R"doc(Construct a new Interpolator object from a vector of pairs usage:
interpolated_y_value = interpolator.interpolate(x_value)
...
static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_XY =
R"doc(< main data vector containing pairs of corresponding x and y
datapoitns)doc";

static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_checkX = R"doc(check if input data is valid (e.g. sorted, no duplicated x values))doc";
...
static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_get_data_XY =
...
R"doc(get neares y values for given x target
...
static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_interpolate_pair =
...
static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_last_x_pair = R"doc(< last pair (for faster consequtive searches))doc";
...
static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_sortX =
...
static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_t_x_pair = R"doc()doc";

static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_t_x_pair_calc_target_data_X =
...
static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_t_x_pair_t_x_pair = R"doc()doc";

static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_t_x_pair_xfactor = R"doc(< 1/(xmax-xmin))doc";

static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_t_x_pair_xmax = R"doc(< larger xvalue)doc";

static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_t_x_pair_xmax_index = R"doc(< index of the larger x value (in the internal vector))doc";

static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_t_x_pair_xmin = R"doc(< smaller xvalue)doc";

static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_I_Interpolator_t_x_pair_xmin_index = R"doc(< index of the smaller x value (in the internal vector))doc";
...
static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_LinearInterpolator_interpolate_pair = R"doc()doc";

static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_LinearInterpolator_linear =
...
static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_NearestInterpolator_interpolate_pair = R"doc()doc";

static const char *__doc_themachinethatgoesping_tools_vectorinterpolators_NearestInterpolator_nearest =
