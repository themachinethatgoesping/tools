...
void init_subm_slerpinterpolator(pybind11::module& m)
{
    ...
    py::class_<SlerpInterpolator>(
        ...
        .def(py::init<const std::vector<double>&,
             ...
             py::arg("extrapolation_mode") = t_extr_mode::extrapolate)
        .def("interpolate",
             py::overload_cast<double, bool>(&SlerpInterpolator::interpolate_ypr),
             DOC(themachinethatgoesping,
                 tools,
                 vectorinterpolators,
                 SlerpInterpolator,
        ...
        .def("interpolate",
             py::overload_cast<const std::vector<double>&, bool>(
                 &SlerpInterpolator::interpolate_ypr),
             DOC(themachinethatgoesping,
                 tools,
                 vectorinterpolators,
                 SlerpInterpolator,
        ...
        .def(
            ...
            py::overload_cast<const std::vector<double>&,
                              ...
                              const std::vector<double>&,
                              const std::vector<double>&,
                              bool>(&SlerpInterpolator::set_data_XY),
            DOC(themachinethatgoesping, tools, vectorinterpolators, SlerpInterpolator, set_data_XY),
            py::arg("X"),
            py::arg("Yaw"),
            py::arg("Pitch"),
            py::arg("Roll"),
