...
#ifndef __DOCSTRINGS_TOOLS_PROGRESSBARS_DOCSTRINGS_CONSOLEPROGRESSBAR_DOC_HPP__
...
#endif // __DOCSTRINGS_TOOLS_PROGRESSBARS_DOCSTRINGS_CONSOLEPROGRESSBAR_DOC_HPP__
#if defined(__GNUG__)
