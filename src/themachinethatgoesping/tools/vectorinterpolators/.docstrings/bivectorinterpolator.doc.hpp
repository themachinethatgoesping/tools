...
#ifndef __DOCSTRINGS_TOOLS_VECTORINTERPOLATORS_DOCSTRINGS_BIVECTORINTERPOLATOR_DOC_HPP__
...
#endif // __DOCSTRINGS_TOOLS_VECTORINTERPOLATORS_DOCSTRINGS_BIVECTORINTERPOLATOR_DOC_HPP__
#if defined(__GNUG__)
