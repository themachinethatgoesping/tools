...
#ifndef __DOCSTRINGS_TOOLS_VECTORINTERPOLATORS_DOCSTRINGS_I_PAIRINTERPOLATOR_DOC_HPP__
...
#endif // __DOCSTRINGS_TOOLS_VECTORINTERPOLATORS_DOCSTRINGS_I_PAIRINTERPOLATOR_DOC_HPP__
#if defined(__GNUG__)
