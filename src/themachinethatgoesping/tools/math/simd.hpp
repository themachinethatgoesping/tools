 ...
 *   neon64 — baseline NEON for all ARM64
 *
 * @authors Peter Urban
 */
...
/// On x86-64: levels v4, v3, v2, v1.  On AArch64: neon64.
...
#else
using dispatch_arch_list = xsimd::arch_list<>;
#endif
...
#elif defined(__aarch64__) || defined(_M_ARM64)
// AArch64 (neon64) — simd_neon64.cpp
