...
static const char *mkd_doc_themachinethatgoesping_tools_helper_int_as_string = R"doc()doc";

static const char *mkd_doc_themachinethatgoesping_tools_helper_string_as_int = R"doc()doc";

static const char *mkd_doc_themachinethatgoesping_tools_helper_string_to_floattype =
...
Args:
    str: if empty or non-numeric a NAN is returned

Template Args:
    t_float: : double or float
