...
{
    auto datestring = "+0000__05-06-2017__08:09:12.123456789";
    ...
    CHECK("+0000__05-06-2017__08:09:12.123456" == timeconv::unixtime_to_datestring(unixtime, 8));
    CHECK("+0000__05-06-2017__08:09:12.123456" == timeconv::unixtime_to_datestring(unixtime, 9));
    CHECK("+0000__05-06-2017__08:09:12.123456" == timeconv::unixtime_to_datestring(unixtime, 10));
}
